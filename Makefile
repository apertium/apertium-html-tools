...
js: build/js/min.js build/js/compat.js build/js/jquery.min.js build/js/bootstrap.min.js build/js/d3.v4.min.js debugjs
...
build/js/d3.v4.min.js: build/js/.d
	curl -Ss 'https://d3js.org/d3.v4.min.js' -o $@
