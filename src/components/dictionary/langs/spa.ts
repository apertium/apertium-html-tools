    ...
    subcats: [
      {
        ...
        subcats: [
          ...
          spaCompound(ctx, 'ifi', 'Compound past perfect [2] (pretérito anterior)'),
      ...
      },
      {
        ...
        subcats: [
          spaP123Table(ctx, 'Present', 'prs'),
          spaP123Table(ctx, 'Past imperfect', 'pis'),
          //spaP123Table(ctx, 'Simple future subjunctive', 'fts'),
          //spaCompound(ctx, 'prs', 'Compound past definite (pretérito perfecto compuesto)'),
          //spaCompound(ctx, 'pis', 'Compound past perfect (pretérito pluscuamperfecto)'),
          //spaCompound(ctx, 'fts', 'Compound future'),
        ],
      },
      {
        id: 'imperative',
